    ...
    React.useEffect(() => {
      ...
      <div>
        ...
        <div className="text-gray-600 body-font">
          <div className="container mx-auto flex px-5 mb-16 mt-4 items-center justify-center flex-col">
            ...
            <div className="container px-5 mt-8 mb-24 mx-auto">
                <div className="flex flex-wrap -m-4">
                  <div className="lg:w-1/3 sm:w-1/3 p-4">
                    <div className="flex relative">
                      <img alt="gallery" className="absolute object-center"
                           src="11.jpg"/>
                    </div>
                  </div>
                  <div className="lg:w-1/3 sm:w-1/3 p-4">
