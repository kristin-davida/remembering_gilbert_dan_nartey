        ...
        <div className="text-gray-600 body-font">
          <div className="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
            <div className="text-center lg:w-2/3 w-full">
              ...
              <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Gilbert Dan-Nartey</h1>
              <h2 className="text-xl mb-8 leading-relaxed">(1938-2023)</h2>
              <p className="mb-8 leading-relaxed">For Gilbert home was where the heart was. He was a magnificent Husband, Father & Grandpa. He will be greatly missed and forever in our hearts. <br></br> Until we meet again, where we will continue to drink, more seriously </p>
